function extract_OF_scrambled_stability
...
save([workingDir filesep 'OF_stability_scrambled.mat'],'stability', 'activity_BL','activity_STIM', 'placeFields_BL','placeFields_STIM', 'OpticSigThreshold')

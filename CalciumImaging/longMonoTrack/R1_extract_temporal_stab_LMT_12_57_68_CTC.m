...
%% Identify time cells
timeCellsProper_1 = temporal_pvalues{1} < 0.05;
timeCellsProper_3 = temporal_pvalues{3} < 0.05;
timeCellsProper_4 = temporal_pvalues{4} < 0.05;
...
for cell_i = 1:length(cellIndex_12)
    ...
    TF_1 = smoothPlaceFieldParam(TF_1,10);
    TF_1 = TF_1-min(TF_1);
    TF_1 = TF_1./max(TF_1);
    ...
    TF_2 = smoothPlaceFieldParam(TF_2,10);
    TF_2 = TF_2-min(TF_2);
    TF_2 = TF_2./max(TF_2);
...
for cell_i = 1:length(cellIndex_35)
    ...
    TF_3 = smoothPlaceFieldParam(TF_3,15);
    TF_3 = TF_3-min(TF_3);
    TF_3 = TF_3./max(TF_3);
    ...
    TF_5 = smoothPlaceFieldParam(TF_5,10);
    TF_5 = TF_5-min(TF_5);
    TF_5 = TF_5./max(TF_5);
...
for cell_i = 1:length(cellIndex_46)
    ...
    TF_4 = smoothPlaceFieldParam(TF_4,10);
    TF_4 = TF_4-min(TF_4);
    TF_4 = TF_4./max(TF_4);
    ...
    TF_6 = smoothPlaceFieldParam(TF_6,10);
    TF_6 = TF_6-min(TF_6);
    TF_6 = TF_6./max(TF_6);
...
save([workingFolder filesep 'R1_LMT_temporal_stability_12_35_46_CTCs.mat'],'stability_12', 'stability_35','stability_46', 'timeFields1', 'timeFields2', 'timeFields3', 'timeFields4', 'timeFields5', 'timeFields6', 'mouse_number')

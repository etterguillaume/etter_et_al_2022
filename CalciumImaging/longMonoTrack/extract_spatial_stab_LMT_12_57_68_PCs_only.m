...
placeCellsProper_1 = spatial_pvalues{1} < 0.05 & temporal_pvalues{1} > 0.05 & distance_pvalues{1}>0.05;
placeCellsProper_3 = spatial_pvalues{3} < 0.05 & temporal_pvalues{3} > 0.05 & distance_pvalues{3}>0.05;
placeCellsProper_4 = spatial_pvalues{4} < 0.05 & temporal_pvalues{4} > 0.05 & distance_pvalues{4}>0.05;
...
save([workingFolder filesep 'LMT_spatial_stability_12_35_46_PCs_only.mat'],'stability_12', 'stability_35','stability_46', 'placeFields1','placeFields2','placeFields3', 'placeFields4', 'placeFields5', 'placeFields6', 'mouse_number')

...
pooled_distance_tuning_curves = pooled_distance_tuning_curves./sum(pooled_distance_tuning_curves);
pooled_spatial_tuning_curves = pooled_spatial_tuning_curves./sum(pooled_spatial_tuning_curves);
pooled_time_tuning_curves = pooled_time_tuning_curves./sum(pooled_time_tuning_curves);
...
for i=1:size(sigSpace_distance_tCurve,2)
    sigSpace_distance_tCurve(:,i) = smoothPlaceField(sigSpace_distance_tCurve(:,i));
    sigSpace_time_tCurve(:,i) = smoothPlaceField(sigSpace_time_tCurve(:,i));
    sigSpace_tuning_curve_data(:,i) = smoothPlaceField(sigSpace_tuning_curve_data(:,i));
end

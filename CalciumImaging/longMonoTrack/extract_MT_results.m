...
for frame_i = 2:length(interp_behav_vec)
    if interp_behav_vec(frame_i) > lap_detect
...
save([workingDir filesep 'MT_results.mat'],'time_MI', 'distance_MI', 'spatial_MI', 'spatial_zMI', 'distance_zMI', 'time_zMI', 'time_MI_pvalue', 'distance_MI_pvalue', 'spatial_MI_pvalue', 'spatial_tuning_curve_data', 'distance_tuning_curve_data', 'time_tuning_curve_data');

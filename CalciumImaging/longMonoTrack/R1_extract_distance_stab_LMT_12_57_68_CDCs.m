...
distanceCellsProper_1 = distance_pvalues{1}<0.05;
distanceCellsProper_3 = distance_pvalues{3}<0.05;
distanceCellsProper_4 = distance_pvalues{4}<0.05;
...
for cell_i = 1:length(cellIndex_12)
    ...
    DF_1 = smoothPlaceFieldParam(DF_1,15);
    DF_1 = DF_1-min(DF_1);
    DF_1 = DF_1./max(DF_1);
    ...
    PF_2 = smoothPlaceFieldParam(PF_2,15);
    PF_2 = PF_2-min(PF_2);
    PF_2 = PF_2./max(PF_2);
...
for cell_i = 1:length(cellIndex_35)
    ...
    PF_3 = smoothPlaceFieldParam(PF_3,15);
    PF_3 = PF_3-min(PF_3);
    PF_3 = PF_3./max(PF_3);
    ...
    PF_5 = smoothPlaceFieldParam(PF_5,15);
    PF_5 = PF_5-min(PF_5);
    PF_5 = PF_5./max(PF_5);
...
for cell_i = 1:length(cellIndex_46)
    ...
    PF_4 = smoothPlaceFieldParam(PF_4,15);
    PF_4 = PF_4-min(PF_4);
    PF_4 = PF_4./max(PF_4);
    ...
    PF_6 = smoothPlaceFieldParam(PF_6,15);
    PF_6 = PF_6-min(PF_6);
    PF_6 = PF_6./max(PF_6);
...
save([workingFolder filesep 'R1_LMT_distance_stability_12_35_46_CDCs.mat'],'stability_12', 'stability_35','stability_46', 'distanceFields1','distanceFields2','distanceFields3', 'distanceFields4', 'distanceFields5', 'distanceFields6', 'mouse_number')
